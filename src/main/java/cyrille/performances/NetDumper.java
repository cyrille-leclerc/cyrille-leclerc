...
/**
 * This hacky class is used to trigger a heap dump on a running VM. To use, start this program like
 * this:
 * 
 * <pre>
 * 
 ...
 * </pre>
 * 
 * This will cause it to listen to a ServerSocket on port 7000. Next, invoke the program you want a
 * heap dump for, like this:
 * 
 * <pre>
 * 
 ...
 * </pre>
 * 
 * It will connect to NetDumper. Whenever you press return in the NetDumper window, it will request
 * a heap dump, and write it to /tmp/foo.hprof.
 */
